...
import net.yasite.riceball.net.HttpConstant;
import net.yasite.riceball.net.SSLSocketFactoryEx;
import net.yasite.riceball.util.ActivityUtil;
...
public abstract class AHttpClient {
	...
	public DefaultHttpClient setHttpClient(DefaultHttpClient httpClient) {
	...
	public HttpUriRequest setRequest(HttpUriRequest request) {
